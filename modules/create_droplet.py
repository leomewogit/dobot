...
def select_region(call: CallbackQuery, data: dict):
    ...
    _t = t + f'Account: <code>{account["email"]}</code>\n\n'
...
def select_size(call: CallbackQuery, data: dict):
    ...
    _t = t + f'Account: <code>{user_dict[call.from_user.id]["account"]["email"]}</code>\n' \
...
def select_image(d: Union[Message, CallbackQuery], data: dict):
    ...
    _t = t + f'Account: <code>{user_dict[d.from_user.id]["account"]["email"]}</code>\n' \
